...
describe('Service Tests', () => {
    describe('Recherche Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Recherche', async () => {
            ...
            it('should update a Recherche', async () => {
                const returnedFromService = Object.assign(
                    {
                        periodicite: 1,
                        emailnotif: true,
            ...
            it('should return a list of Recherche', async () => {
                const returnedFromService = Object.assign(
                    {
                        periodicite: 1,
                        emailnotif: true,
            ...
            it('should delete a Recherche', async () => {
