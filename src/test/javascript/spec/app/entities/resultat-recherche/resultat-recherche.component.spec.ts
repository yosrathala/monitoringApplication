...
import { ResultatRechercheComponent } from 'app/entities/resultat-recherche/resultat-recherche.component';
...
describe('Component Tests', () => {
    describe('ResultatRecherche Management Component', () => {
        let comp: ResultatRechercheComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResultatRechercheComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ResultatRecherche(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.resultatRecherches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
