...
import { MotcleComponent } from 'app/entities/motcle/motcle.component';
import { MotcleService } from 'app/entities/motcle/motcle.service';
import { Motcle } from 'app/shared/model/motcle.model';

describe('Component Tests', () => {
    describe('Motcle Management Component', () => {
        let comp: MotcleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MotcleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.motcles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
