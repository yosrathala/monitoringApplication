...
import { ResultatItemComponent } from 'app/entities/resultat-item/resultat-item.component';
...
describe('Component Tests', () => {
    describe('ResultatItem Management Component', () => {
        let comp: ResultatItemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResultatItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.resultatItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
